...
def update_source_version_number(version):
    ...
    SOURCE_VERSION = f"htool-{version.build_version_major}{version.build_version_minor}{version.build_version_revision}.{version.source_version_major}.{version.source_version_minor}"
...
def write_version_header(header_name, mv_name, template, version):
    ...
    source_version = f"htool-{build_version_condensed}.{version.source_version_major}.{version.source_version_minor}"

    header = template.render(
        HTOOL_BUILD_VERSION_MAJOR_VAL=version.build_version_major,
        HTOOL_BUILD_VERSION_MINOR_VAL=version.build_version_minor,
        HTOOL_BUILD_VERSION_REVISION_VAL=version.build_version_revision,
        HTOOL_SOURCE_VERSION_MAJOR_VAL=version.source_version_major,
        HTOOL_SOURCE_VERSION_MINOR_VAL=version.source_version_minor,
        HTOOL_BUILD_TYPE_VAL=version.build_type,
        HTOOL_BUILD_VERSION=build_version,
        HTOOL_SOURCE_VERSION=source_version,
    )
